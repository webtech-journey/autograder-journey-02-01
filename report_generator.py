...
| Existência do Resumo.txt  | {25 if test_results[2] else 0}     | {pass_or_fail(test_results[2])} |
| Conteúdo do Resumo.txt    | {25 if test_results[3] else 0}     | {pass_or_fail(test_results[3])} |
'''
